...
const Healthform: React.FC = () => {
    ...
    const handleDashBoard = (event: React.MouseEvent<HTMLButtonElement>) => {
...
display: flex;
  ...
  background-color: rgba(17, 24, 39, 1); /* Optional: Set a background color */
//   .form-container {
//     width: 320px;
...
.form-container {
    width: 320px;
    border-radius: 0.75rem;
    background-color: rgba(31, 41, 55, 1); /* Slightly lighter than background */
    padding: 2rem;
    color: rgba(243, 244, 246, 1);
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.25); /* Add slight shadow for better visibility */
  }
  .title {
    text-align: center;
    font-size: 1.5rem;
